...
if __name__ == '__main__':
    ...
    messagebox.showinfo('title','if you find yourself to cross a piranha river here is how to do it ')
    # Get the player to enter an adjective
    adjective=simpledialog.askstring('title','Can you please put an adjective?')
    # Get the player to enter a type of liquid
    type_of_liquid=simpledialog.askstring('title', 'Can you please put a type of liquid?')
    # Get the player to enter a body part
    body_part=simpledialog.askstring('title','Can you please put a body part?')
    # Get the player to enter a verb
    verb=simpledialog.askstring('title','Can you please put a verb')
    # Get the player to enter a place
    place=simpledialog.askstring('title', 'Can you please put a place?')
